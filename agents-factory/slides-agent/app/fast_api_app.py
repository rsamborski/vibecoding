...
bucket_name = f"gs://{project_id}-slides-agent-logs"
...
agent_name = os.environ.get("AGENT_ENGINE_SESSION_NAME", "slides-agent")
...
app.title = "slides-agent"
app.description = "API for interacting with the Agent slides-agent"
