...
bucket_name = f"gs://{project_id}-slides-agent2-logs"
...
if use_in_memory_session:
    ...
    agent_name = os.environ.get(
        "AGENT_ENGINE_SESSION_NAME", "slides-agent2"
    )
...
app.title = "slides-agent2"
app.description = "API for interacting with the Agent slides-agent2"
