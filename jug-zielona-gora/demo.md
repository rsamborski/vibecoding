...
* Run Gemini-CLI in ~/projects/vibecoding/jug-zielona-gora/demo
...
```
Create a simple 3-tier newsfeed application based on the @jug-zielona-gora-demo.png diagram. Technical stack details are presented on the diagram.
...
```
Generate a logo for this project that matches its spirit. Its aspiring to be a main source of news for its users. Save it in a folder accessible by the frontend app. The logo should have a maximum height of 100px.
```
